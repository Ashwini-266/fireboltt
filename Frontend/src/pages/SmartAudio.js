...
function SmartAudio(){
  ...
  useEffect(() => {
    ...
    let url = "http://localhost:3001/products/category/smartaudio";
  ...
  const addProduct = async (product) => {
    ...
    return(
        ...
        <div>
          <img src="/images/smartAudio/saimg.webp" alt="Smart Audio" style={{width:"100%"}} />
        </div>
        <div>
          <p className="title"><b>Smart Audio</b></p>
        </div>
